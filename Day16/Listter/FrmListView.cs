    ...
    public partial class FrmListView : Form
    {
        ...
        private void TxtSearch_TextChanged(object sender, EventArgs e)
        {
            if (FrmMainpage.type == "Movies")
            {
                ...
                dataGridView1.Columns.Clear();
                int i = 0;
                SqlCommand command1 = new SqlCommand("SELECT Tbl_Movies.ID, Tbl_Movies.MovieName,Tbl_Movies.MoviePhoto FROM Tbl_ListContents,Tbl_Lists,Tbl_Movies WHERE Tbl_ListContents.Listid=Tbl_Lists.ID AND Tbl_ListContents.Movieid=Tbl_Movies.ID And Tbl_Lists.ID=@p1 And MovieName like '" + TxtSearch.Text + "%'", bgl.connection());
                command1.Parameters.AddWithValue("@p1", FrmMainpage.Listid);
                SqlDataAdapter da = new SqlDataAdapter(command1);
                DataTable dt = new DataTable();
                da.Fill(dt);
            ...
            else if (FrmMainpage.type == "Books")
            {
                ...
                dataGridView1.Columns.Clear();
                int i = 0;
                SqlCommand command1 = new SqlCommand("SELECT Tbl_Books.ID, Tbl_Books.BookName,Tbl_Books.BookPhoto FROM Tbl_ListContents,Tbl_Lists,Tbl_Books WHERE Tbl_ListContents.Listid=Tbl_Lists.ID AND Tbl_ListContents.Bookid=Tbl_Books.ID And Tbl_Lists.ID=@p1 And BookName like '" + TxtSearch.Text + "%'", bgl.connection());
                command1.Parameters.AddWithValue("@p1", FrmMainpage.Listid);
                SqlDataAdapter da = new SqlDataAdapter(command1);
                DataTable dt = new DataTable();
                da.Fill(dt);
            ...
            else if (FrmMainpage.type == "Series")
            {
                ...
                dataGridView1.Columns.Clear();
                int i = 0;
                SqlCommand command1 = new SqlCommand("SELECT Tbl_Series.ID, Tbl_Series.SeriesName,Tbl_Series.SeriesPhoto FROM Tbl_ListContents,Tbl_Lists,Tbl_Series WHERE Tbl_ListContents.Listid=Tbl_Lists.ID AND Tbl_ListContents.Seriesid=Tbl_Series.ID And Tbl_Lists.ID=@p1 And SeriesName like '" + TxtSearch.Text + "%'", bgl.connection());
                command1.Parameters.AddWithValue("@p1", FrmMainpage.Listid);
                SqlDataAdapter da = new SqlDataAdapter(command1);
                DataTable dt = new DataTable();
                da.Fill(dt);
