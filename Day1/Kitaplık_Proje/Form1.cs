...
namespace Kitaplık_Proje
{
    public partial class Form1 : Form
    {
        ...
        private void BtnKaydet_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Close();
            MessageBox.Show("Book Saved To The System!", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
            listele();
        }
        ...
        private void BtnSil_Click(object sender, EventArgs e)
        {
            ...
            komut1.ExecuteNonQuery();
            baglanti.Close();
            MessageBox.Show("Book deleted from list", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
            listele();
        }
        ...
        private void BtnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Close();
            MessageBox.Show("Record Updated", "Informations", MessageBoxButtons.OK, MessageBoxIcon.Information);
            listele();
        }
        ...
        private void BtnBul_Click(object sender, EventArgs e)
        {
            ...
            komut.Parameters.AddWithValue("@p1", TxtArananKitap.Text);
            DataTable dt = new DataTable();
        ...
        {
            OleDbCommand komut = new OleDbCommand("Select *From Kitaplar where KitapAd like '%" + TxtArananKitap.Text + "%'", baglanti);
            komut.Parameters.AddWithValue("@p1", TxtArananKitap.Text);
            DataTable dt = new DataTable();
            OleDbDataAdapter da = new OleDbDataAdapter(komut);
            da.Fill(dt);
        ...
        private void TxtArananKitap_TextChanged(object sender, EventArgs e)
        {
            OleDbCommand komut = new OleDbCommand("Select *From Kitaplar where KitapAd like '" + TxtArananKitap.Text + "%'", baglanti);
            komut.Parameters.AddWithValue("@p1", TxtArananKitap.Text);
            DataTable dt = new DataTable();
